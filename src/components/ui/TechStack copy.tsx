...
import { 
  ...
  SiKubernetes, SiTerraform, SiGraphql, SiLinux, SiHtml5, SiCss3, SiCplusplus, SiCsharp, 
  SiJava, SiPhp, SiLaravel, SiSpring, SiFlutter, SiKotlin, SiSwift, SiMysql, SiRedis, SiUbuntu
} from 'react-icons/si';
