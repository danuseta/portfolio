...
import { 
  SiReact, SiFigma, SiAdobexd, SiSketch, SiNextdotjs, SiTailwindcss, SiFirebase, SiTypescript,
  SiJavascript, SiNodedotjs, SiMongodb, SiPostgresql, SiPython, SiDjango, SiDocker, SiGit,
  SiAngular, SiVuedotjs, SiSass, SiWebpack, SiVite, SiRuby, SiRubyonrails, SiGo,
  SiKubernetes, SiTerraform, SiGraphql, SiLinux, SiHtml5, SiCss3, SiCplusplus, SiPhp, SiLaravel, SiSpring, SiFlutter, SiKotlin, SiSwift, SiMysql, SiRedis, SiUbuntu,
  SiJest, SiEslint, SiPrettier, SiGooglecloud, SiServerless, SiSentry, SiStrapi, 
  SiAuth0, SiNestjs, SiExpress, SiRedux, SiApollographql, SiJquery, SiSvelte, SiElectron,
  SiAlgolia, SiApachecouchdb , SiD3Dotjs, SiChartdotjs, SiVercel, SiNetlify, SiGithub, SiGitlab, 
  SiBitbucket, SiRabbitmq, SiNginx, SiCypress, SiMocha, SiCircleci, SiJenkins,
  SiPrisma, SiHasura, SiSalesforce, SiOpenai, SiShopify, SiWordpress, SiDigitalocean,
  SiContentful, SiSanity, SiAntdesign, SiBootstrap, SiChakraui, SiStorybook,
  SiPostman, SiSwagger, SiSonarqube, SiSelenium, SiTrello, SiJira, SiConfluence, SiSlack,
  SiWebstorm, SiIntellijidea, SiEclipseide , SiAndroidstudio, SiXcode,
  SiUnity, SiUnrealengine, SiBlender, SiFastapi, SiDotnet, SiRust, SiDart,
  SiApachekafka, SiElasticsearch, SiInfluxdb, SiGrafana, SiKibana, SiPrometheus, SiAnsible,
  SiVagrant, SiReactrouter, SiWebgl, SiThreedotjs, SiBabel,
  SiFramer, SiGreensock, SiGatsby, SiNuxtdotjs, SiRemix, SiStyledcomponents,
  SiZod, SiPostcss, SiRollupdotjs, SiWebassembly, SiDeno, SiVitest,
  SiTestinglibrary, SiPnpm, SiYarn, SiNpm, SiComposer, SiGradle, SiApachemaven, SiCockroachlabs,
  SiNeo4J, SiMariadb, SiSqlite, SiSupabase, SiPlanetscale, SiClickhouse, SiApachecassandra,
  SiMinutemailer, SiMailchimp, SiSendgrid, SiStripe, SiPaypal, SiSquare, SiLetsencrypt,
  SiCloudflare, SiAkamai, SiFastly, SiUml, SiMarkdown, SiAsana, SiNotion, SiLinear,
  SiClickup, SiCanva, SiInvision, SiMiro, SiFontawesome, SiInsomnia,
  SiSequelize, SiTypeorm, SiMongoose, SiReduxsaga, SiReacthookform, SiReactquery,
  SiVim, SiNeovim, SiSublimetext, SiGnuemacs
} from 'react-icons/si';
...
const categories = {
  frontend: {
    name: 'Frontend',
    items: ['React', 'Next.js', 'Vue.js', 'Angular', 'Svelte', 'HTML5', 'CSS3', 'JavaScript', 'TypeScript', 'React Router', 'Gatsby', 'Nuxt.js', 'Remix', 'Three.js', 'WebGL']
  },
  styling: {
    name: 'Styling & UI',
    items: ['Tailwind', 'SASS', 'Bootstrap', 'Material UI', 'Chakra UI', 'Ant Design', 'Styled Components', 'Windi CSS', 'PostCSS']
  },
  state: {
  ...
  backend: {
    name: 'Backend',
    items: ['Node.js', 'Express', 'NestJS', 'Django', 'FastAPI', 'Spring', '.NET', 'Laravel', 'Ruby on Rails', 'Deno']
  },
  mobile: {
  ...
  database: {
    name: 'Databases',
    items: ['PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'Elasticsearch', 'InfluxDB', 'CouchDB', 'Cockroach DB', 'Neo4j', 'MariaDB', 'SQLite', 'Supabase', 'PlanetScale', 'ClickHouse', 'Cassandra']
  },
  orm: {
    name: 'ORM & ODM',
  ...
  cloud: {
    name: 'Cloud & Hosting',
    items: ['AWS', 'Azure', 'Google Cloud', 'DigitalOcean', 'Vercel', 'Netlify', 'Heroku', 'Firebase']
  },
  devops: {
    name: 'DevOps & CI/CD',
  ...
  testing: {
    name: 'Testing',
    items: ['Jest', 'Cypress', 'Selenium', 'Karma', 'Mocha', 'SonarQube', 'Vitest', 'Playwright', 'Testing Library']
  },
  tools: {
    name: 'Development Tools',
    items: ['Git', 'GitHub', 'GitLab', 'Postman', 'Swagger', 'VSCode', 'WebStorm', 'IntelliJ IDEA', 'Vim', 'Neovim', 'Atom', 'Sublime Text', 'Emacs']
  },
  packageManagers: {
  ...
  languages: {
    ...
    items: ['JavaScript', 'TypeScript', 'Python', 'Java', 'C++', 'C#', 'Go', 'Rust', 'Dart', 'Ruby', 'PHP', 'WebAssembly']
  },
  monitoring: {
...
export default function TechStack({ 
  ...
  return (
    <div className={`grid gap-6 ${columns > 1 ? `grid-cols-1 md:grid-cols-${columns}` : ''} ${className}`}>
